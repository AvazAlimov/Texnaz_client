...
// Menu items
module.exports.SHOW_STATISTICS = {
  name: 'show statistics',
  id: 2,
};
module.exports.SHOW_CALCULATOR = {
  name: 'show calculator',
  id: 3,
};
module.exports.SHOW_PRICES = {
  name: 'show prices',
  id: 4,
};
module.exports.SHOW_WAREHOUSES = {
  name: 'show warehouses',
  id: 5,
};
module.exports.SHOW_MANAGERS = {
  name: 'show managers',
  id: 6,
};
module.exports.SHOW_CLIENTS = {
  name: 'show clients',
  id: 7,
};
module.exports.SHOW_SHIPMENTS = {
  name: 'show shipments',
  id: 8,
};
module.exports.SHOW_PAYMENTS = {
  name: 'show payments',
  id: 9,
};
module.exports.SHOW_MY_EXPANSES = {
  name: 'show my expances',
  id: 10,
};
module.exports.SHOW_SETTINGS = {
  name: 'show settings',
  id: 11,
};
