    ...
    return {
      cards: [
        ...
        },
        {
          ...
          title: 'Перемещение',
          to: { name: 'move' },
          permission: false, // this.$permissions.SHOW_WAREHOUSE_MOVE.name,
        },
        {
          counter: 0,
          id: 'booking',
        ...
        },
        {
          ...
          permission: false, // this.$permissions.SHOW_WAREHOUSE_RETURN.name,
        },
        {
          counter: 0,
          id: 'losts',
          ...
          to: { name: 'loststocks' },
          permission: false, // this.$permissions.SHOW_WAREHOUSE_LOST_STOCKS.name,
        },
        {
          counter: 0,
          id: 'sale',
        ...
        },
        {
          ...
          to: { name: 'prestocks' },
          permission: false, // this.$permissions.SHOW_WAREHOUSE_PRE_STOCKS.name,
        },
        {
          counter: 0,
          id: 'moves',
          title: 'Прием',
          to: { name: 'acceptance' },
          permission: false, // this.$permissions.SHOW_WAREHOUSE_ACCEPTANCE.name,
        },
        {
          counter: 0,
          id: 'returnHistory',
